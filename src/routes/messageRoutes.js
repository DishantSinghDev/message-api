...
router.post("/send", validateMessage, rateLimiter("sendMessage", 2000, 60), sendMessage)
...
router.post("/typing", rateLimiter("typing", 30000, 10), sendTypingIndicator)
...
router.get("/:messageId", rateLimiter("getMessage", 30000, 60), getAMessage)
